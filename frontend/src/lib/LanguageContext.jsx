...
const contentTranslations = {
  ti: {
    ...
    "Today's Front Page": "ናይ ሎሚ ቀዳማይ ገጽ",
    "Independent reporting, community stories, and practical access": "ናጻ ሪፖርታዥ፣ ዛንታታት ማሕበረሰብን ግብራዊ መእተዊን",
    "Edition 01 · Vol. 12": "ሕታም 01 · ቅጽ 12",
    "News Desk": "ክፍሊ ዜና",
    "Stories worth keeping": "ክትሕዞም ዝግባእ ዛንታታት",
    "Fresh reporting, clear context, and the stories shaping the week.": "ሓድሽ ሪፖርታዥ፣ ንጹር ኣውድን ንሰሙን ዝቐርጹ ዛንታታትን።",
    "Editor's Note": "መዘኻኸሪ ኤዲተር",
    "Watch a concise guide that shows how the paper works, where to find key sections, and how readers can move from headlines to subscriptions or business information.": "እቲ ጋዜጣ ከመይ ከም ዝሰርሕ፣ ኣገደስቲ ክፍልታት ኣበይ ከም ዝርከቡ፣ ኣንበብቲ ድማ ካብ ርእሰ-ዜናታት ናብ ምዝገባ ወይ ናይ ንግዲ ሓበሬታ ከመይ ከም ዝኸዱ ዘርኢ ሓጺር መምርሒ ርአ።",
    "Featured Playback": "ፍሉይ ምርኣይ",
    "Kept intentionally short and clear so the section feels like an editorial explainer, not a generic embedded video.": "እዚ ክፍሊ ከም ኤዲቶርያላዊ መብርሂ እምበር ከም ሓፈሻዊ ዝተኣተወ ቪድዮ ከይመስል ሓጺርን ንጹርን ተገይሩ ኣሎ።",
    "YouTube Guide": "መምርሒ YouTube",
    "Quick overview for readers and partners": "ንኣንበብትን መሻርኽትን ሓጺር ሓፈሻዊ ምርኣይ",
    "User guide video": "ናይ ተጠቃሚ መምርሒ ቪድዮ",
    "Newspaper delivery and print operations": "መብጽሒ ጋዜጣን ስራሕቲ ሕትመትን",
    "Business team reviewing printed newspaper delivery plans": "ናይ ንግዲ ጉጅለ መደባት መብጽሒ ዝተሓትመ ጋዜጣ ይመርምር",
    "Company pricing is separate": "ናይ ትካል ዋጋ ፍሉይ እዩ",
    "Bulk copies, locations, and invoicing follow a quote-led business workflow.": "ብዝሒ ቅዳሓት፣ ቦታታትን ክፍሊትን ብናይ ንግዲ መስርሕ ቅድሚ ዋጋ ምቕራብ ይምርሑ።",
    "Explore business plans": "ናይ ንግዲ ውጥናት ዳህስስ",
    "Cadence": "ተደጋጋምነት",
    "Biweekly print delivery": "ኣብ ክልተ ሰሙን ሓንሳብ መብጽሒ ሕትመት",
    "Tracking source": "ምንጪ ክትትል",
    "Existing fleet and map system": "ዘሎ ስርዓት መርከባትን ካርታን",
    Coverage: "ሽፋን",
    "Belgium and Germany routing ready": "መስመር ቤልጅየምን ጀርመንን ድሉው እዩ",
    "Bulk copy management": "ምምሕዳር ብዝሒ ቅዳሓት",
    "Order physical newspapers in volume for offices, receptions, hotels, and partner sites.": "ንቤት ጽሕፈታት፣ መቐበሊታት፣ ሆቴላትን ቦታታት መሻርኽትን ኣካላዊ ጋዜጣታት ብብዝሒ እዘዝ።",
    "Volume-based pricing": "ብመሰረት ብዝሒ ዋጋ",
    "Company pricing can scale by order size instead of using individual-reader plan rules.": "ናይ ትካል ዋጋ ኣብ ክንዲ ሕግታት ውጥን ውልቃዊ ኣንባቢ፣ ብመጠን ትእዛዝ ክዓቢ ይኽእል።",
    "Consolidated invoicing": "ዝተዋሃደ መጠየቕታ ክፍሊት",
    "Handle billing and renewal activity from one place instead of splitting charges across staff accounts.": "ክፍሊትን ምሕዳስን ኣብ ክንዲ ኣብ ሕሳባት ሰራሕተኛታት ምምቕቓል፣ ካብ ሓደ ቦታ ኣመሓድር።",
    "Multi-location tracking": "ክትትል ብዙሓት ቦታታት",
    "Monitor shipment progress across several delivery points from a shared company workspace.": "ካብ ሓባራዊ ናይ ትካል ቦታ ስራሕ፣ ምዕባለ ጽዕነት ኣብ ሓያሎ ነጥብታት መብጽሒ ተኸታተል።",
    "Account model": "ሞዴል ሕሳብ",
    "Individual and business flows stay separate": "መስርሓት ውልቀን ንግድን ፍሉያት ይቕጽሉ",
    Billing: "ክፍሊት",
    "Contract and invoice-friendly": "ንውዕልን መጠየቕታ ክፍሊትን ዝምችእ",
    "Delivery view": "ምርኣይ መብጽሒ",
    "Single-location or consolidated route tracking": "ክትትል ሓደ ቦታ ወይ ዝተዋሃደ መስመር",
    "Commercial email": "ናይ ንግዲ ኢመይል",
    "Best for quote requests, invoicing questions, and commercial rollout planning.": "ንሕቶታት ዋጋ፣ ሕቶታት ክፍሊትን መደብ ምዝርጋሕ ንግድን ዝበለጸ።",
    "Email commercial team": "ናይ ንግዲ ጉጅለ ኢመይል ስደድ",
    "Billing desk": "ክፍሊ ክፍሊት",
    "Use this for invoice structure, VAT questions, or company payment expectations.": "እዚ ንቅርጺ መጠየቕታ ክፍሊት፣ ሕቶታት VAT ወይ ትጽቢታት ክፍሊት ትካል ተጠቐመሉ።",
    "Contact billing": "ክፍሊ ክፍሊት ርኸብ",
    "Business intake": "መጀመርታ ንግዲ",
    "Start with your expected volume and delivery footprint.": "ብትጽቢት ብዝሒኻን ሽፋን መብጽሒኻን ጀምር።",
    "The intake path should include organization details, locations, volume, and invoicing preferences.": "መንገዲ መጀመርታ ዝርዝር ትካል፣ ቦታታት፣ ብዝሒን ምርጫታት ክፍሊትን ከጠቓልል ይግባእ።",
    "Open intake section": "ክፍሊ መጀመርታ ክፈት",
    "Print and Logistics": "ሕትመትን ሎጂስቲክስን",
    "Track every print run from press to doorstep.": "ኩሉ ዙር ሕትመት ካብ ፕሬስ ክሳብ ደገ ተኸታተል።",
    "See Print Plans": "ናይ ሕትመት ውጥናት ርአ",
    "Business subscriptions built for teams.": "ንጉጅለታት ዝተሰርሑ ናይ ንግዲ ምዝገባታት።",
    "View Business Offer": "ናይ ንግዲ ቅርበት ርአ",
    "Talk to Sales": "ምስ ሽያጭ ተዘራረብ",
    "Inside this edition": "ኣብዚ ሕታም",
    "A considered story for readers who want context, not noise.": "ንኣውድ ዝደልዩ ኣንበብቲ፣ እምበር ድምጺ ዘይደልዩ፣ ዝተመርመረ ዛንታ።",
    "Read feature": "ፍሉይ ጽሑፍ ኣንብብ",
    "No articles in this category yet.": "ኣብዚ ምድብ ገና ጽሑፋት የለዉን።",
    "Browse subcategories": "ንንኡሳን ምድባት ዳህስስ",
    "Subscriptions and Access": "ምዝገባታትን መእተዊን",
    "Choose a plan with the real product rules up front.": "ምስ ግልጺ ሕግታት ኣገልግሎት ውጥንካ ምረጽ።",
    "Reader subscriptions are billed monthly or yearly, print delivery still runs every two weeks, and recent reporting stays reserved for active subscribers before it moves into the public archive 30 days later.": "ናይ ኣንባቢ ምዝገባታት ብወርሒ ወይ ብዓመት ይኽፈሉ፣ መብጽሒ ሕትመት ድማ ኣብ ክልተ ሰሙን ሓንሳብ ይቕጽል፣ ሓድሽ ሪፖርታዥ ድማ ቅድሚ ድሕሪ 30 መዓልታት ናብ ህዝባዊ ማህደር ምእታዉ ንንጡፋት ተመዝገብቲ ይሕለው።",
    "Monthly billing": "ወርሓዊ ክፍሊት",
    "Yearly billing": "ዓመታዊ ክፍሊት",
    "Reader catalog": "ካታሎግ ኣንባቢ",
    "These plans are for individual reader access. Companies request bulk orders at their own negotiated volumes and confirmed prices on the business page.": "እዞም ውጥናት ንመእተዊ ውልቃዊ ኣንባቢ እዮም። ትካላት ኣብ ገጽ ንግዲ ብዝተዘራረቡሉ ብዝሕን ብዝተረጋገጸ ዋጋን ብዝሒ ትእዛዝ ይሓቱ።",
    "Explore bulk ordering": "ብዝሒ ትእዛዝ ዳህስስ",
    "Reader favorite": "ተመራጺ ኣንባቢ",
    "Request business plan": "ናይ ንግዲ ውጥን ሕተት",
    "Continue to checkout": "ናብ ክፍሊት ቀጽል",
    Custom: "ልዩ",
    "contact sales": "ሽያጭ ርኸብ",
    "/year": "/ዓመት",
    "Business account": "ናይ ንግዲ ሕሳብ",
    "Newspapers for your organization.": "ጋዜጣታት ንትካልኩም።",
    "Register your company, upload its business licence for approval, then add delivery locations and place bulk newspaper orders from your workspace.": "ትካልኩም መዝግቡ፣ ፍቓድ ንግዲ ንምጽዳቕ ስቐሉ፣ ድሕሪኡ ቦታታት መብጽሒ ወስኹን ካብ ቦታ ስራሕኩም ብዝሒ ትእዛዝ ጋዜጣ ኣቕርቡን።",
    "Register your company": "ትካልኩም መዝግቡ",
    "Bulk orders": "ብዝሒ ትእዛዛት",
    "Order physical newspaper copies for approved company locations.": "ንዝጸደቑ ናይ ትካል ቦታታት ኣካላዊ ቅዳሓት ጋዜጣ እዘዙ።",
    "Delivery locations": "ቦታታት መብጽሒ",
    "Save verified delivery locations and follow shipment progress.": "ዝተረጋገጹ ቦታታት መብጽሒ ዓቅቡን ምዕባለ ጽዕነት ተኸታተሉን።",
    "Approved company access": "ዝጸደቐ መእተዊ ትካል",
    "Company sign-in is enabled after an admin approves the uploaded business licence.": "ኣስተዳዳሪ ዝተሰቐለ ፍቓድ ንግዲ ድሕሪ ምጽዳቑ መእተዊ ትካል ይነቃቃሕ።",
    "Already approved?": "ድሮ ጸዲቑ?",
    "All News": "ኩሉ ዜና",
    "The stories shaping today’s edition": "ንሕታም ሎሚ ዝቐርጹ ዛንታታት",
    "Browse published reporting across politics, business, sport, culture, and community. Subscriber-only stories follow their configured access and public release date.": "ኣብ ፖለቲካ፣ ንግዲ፣ ስፖርት፣ ባህልን ማሕበረሰብን ዝተሓትመ ሪፖርታዥ ዳህስሱ። ንተመዝገብቲ ጥራይ ዝተወሰኑ ዛንታታት ብዝተወሰነ መእተዊኦምን ዕለት ህዝባዊ ምውጻኦምን ይምርሑ።",
    "Read with access": "ብመእተዊ ኣንብብ",
    "Go to previous page": "ናብ ዝሓለፈ ገጽ ኪድ",
    "Go to next page": "ናብ ዝቕጽል ገጽ ኪድ",
    Page: "ገጽ",
    of: "ካብ",
    pagination: "ምቕያር ገጻት",
    Previous: "ዝሓለፈ",
    Next: "ዝቕጽል",
    "More pages": "ተወሳኺ ገጻት",
    "Contact support": "ደገፍ ርኸብ",
    "Help with reader access, business approval, bulk orders, or delivery.": "ንመእተዊ ኣንባቢ፣ ምጽዳቕ ትካል፣ ብዝሒ ትእዛዝ ወይ መብጽሒ ሓገዝ ርኸብ።",
    "Use the form to prepare a support email, or manage account-specific subscriptions, delivery, and company operations from the appropriate workspace.": "ንኢመይል ደገፍ ንምድላው እቲ ቅጥዒ ተጠቐሙ፣ ወይ ናይ ሕሳብ ምዝገባ፣ መብጽሒን ስራሕቲ ትካልን ካብ ተገቢ ቦታ ስራሕ ኣመሓድሩ።",
    "Email reader support": "ናብ ደገፍ ኣንባቢ ኢመይል ስደድ",
    "Email business support": "ናብ ደገፍ ንግዲ ኢመይል ስደድ",
    "Reader and editorial support": "ደገፍ ኣንባቢን ኤዲቶርያልን",
    "Ask about subscriptions, account access, published articles, or print delivery.": "ብዛዕባ ምዝገባ፣ መእተዊ ሕሳብ፣ ዝተሓትሙ ጽሑፋት ወይ መብጽሒ ሕትመት ሕተቱ።",
    "Business support": "ደገፍ ንግዲ",
    "Use this route for company registration, licence approval, delivery locations, bulk orders, invoices, and shipments.": "እዚ መንገዲ ንምዝገባ ትካል፣ ምጽዳቕ ፍቓድ፣ ቦታታት መብጽሒ፣ ብዝሒ ትእዛዝ፣ መጠየቕታታት ክፍሊትን ጽዕነታትን ተጠቐሙ።",
    "Include your company name and the request you need help with.": "ስም ትካልኩምን ዝደለኹምዎ ሓገዝን ኣካትቱ።",
    "Your email is ready": "ኢመይልኩም ድሉው እዩ",
    "Send the message from your email application to contact support. For account-specific actions, use your reader or business workspace.": "ንደገፍ ንምርካብ እቲ መልእኽቲ ካብ መተግበሪ ኢመይልኩም ስደዱ። ንናይ ሕሳብ ስራሕቲ ናይ ኣንባቢ ወይ ናይ ትካል ቦታ ስራሕ ተጠቐሙ።",
    "Prepare another message": "ካልእ መልእኽቲ ኣዳሉ",
    "Tell us what you need": "እንታይ ከም እትደልዩ ንገሩና",
    "Choose a topic and we will prepare an email to the support address configured for this platform.": "ሓደ ኣርእስቲ ምረጹ፣ ንዚ መድረኽ ናብ ዝተዋቐረ ኣድራሻ ደገፍ ኢመይል ክንዳሉ ኢና።",
    "Your full name": "ሙሉእ ስምኩም",
    "Share the details that will help support assist you.": "ደገፍ ክሕግዘኩም ዝኽእል ዝርዝር ሓበሬታ ኣካፍሉ።",
    "The form opens an email addressed to platform support.": "እቲ ቅጥዒ ናብ ደገፍ መድረኽ ዝተመርሐ ኢመይል ይኸፍት።",
    "Prepare email": "ኢመይል ኣዳሉ",
    "Use the right workspace": "ተገቢ ቦታ ስራሕ ተጠቐሙ",
    "Readers manage subscriptions and delivery history in the reader workspace. Approved companies manage locations, orders, invoices, and shipments in the business workspace.": "ኣንበብቲ ምዝገባን ታሪኽ መብጽሒን ኣብ ቦታ ስራሕ ኣንባቢ የመሓድሩ። ዝጸደቑ ትካላት ቦታታት፣ ትእዛዛት፣ መጠየቕታታት ክፍሊትን ጽዕነታትን ኣብ ቦታ ስራሕ ንግዲ የመሓድሩ።",
    "News, subscriptions, and delivery operations in one platform.": "ዜና፣ ምዝገባን ስራሕቲ መብጽሕን ኣብ ሓደ መድረኽ።",
    "ንቐደም combines a bilingual newsroom with reader subscriptions, print delivery, and approved company workspaces for bulk newspaper ordering.": "ንቐደም ክልተ ቋንቋ ዘለዎ ክፍሊ ዜና ምስ ምዝገባ ኣንባቢ፣ መብጽሒ ሕትመትን ንብዝሒ ትእዛዝ ጋዜጣ ዝጸደቑ ቦታታት ስራሕ ትካልን የዋህድ።",
    "Read the latest edition": "ሓድሽ ሕታም ኣንብብ",
    "View subscription plans": "ውጥናት ምዝገባ ርአ",
    "Reader access": "መእተዊ ኣንባቢ",
    "Digital + print": "ዲጂታል + ሕትመት",
    "Print cadence": "ተደጋጋምነት ሕትመት",
    "Every two weeks": "ኣብ ክልተ ሰሙን ሓንሳብ",
    "Company workflow": "መስርሕ ትካል",
    "Licence approval": "ምጽዳቕ ፍቓድ",
    Delivery: "መብጽሒ",
    "Saved locations": "ዝተዓቀቡ ቦታታት",
    "Nekedem platform operations": "ስራሕቲ መድረኽ ንቐደም",
    "How the platform works": "እቲ መድረኽ ከመይ ከም ዝሰርሕ",
    "A platform built for readers and delivery teams": "ንኣንበብትን ጉጅለታት መብጽሕን ዝተሰርሐ መድረኽ",
    "ንቐደም is a bilingual digital and print news platform built around clear reader access, editorial publishing, and reliable delivery operations.": "ንቐደም ኣብ ግልጺ መእተዊ ኣንባቢ፣ ኤዲቶርያላዊ ሕትመትን እሙን ስራሕቲ መብጽሕን ዝተመርኮሰ ክልተ ቋንቋ ዲጂታልን ሕትመትን መድረኽ ዜና እዩ።",
    "Readers can subscribe for digital access and scheduled print editions. Recent articles can stay subscriber-only until an editorially controlled public release date.": "ኣንበብቲ ንዲጂታላዊ መእተዊን ንዝተወጠነ ሕታማት ሕትመትን ክምዝገቡ ይኽእሉ። ሓደስቲ ጽሑፋት ክሳብ ብኤዲቶር ዝተቖጻጸረ ዕለት ህዝባዊ ምውጻእ ንተመዝገብቲ ጥራይ ክቕጽሉ ይኽእሉ።",
    "Approved companies manage delivery locations, bulk newspaper orders, invoices, and shipments from one workspace after an administrator verifies their business licence.": "ኣስተዳዳሪ ፍቓድ ንግዶም ድሕሪ ምርግጋጹ፣ ዝጸደቑ ትካላት ቦታታት መብጽሒ፣ ብዝሒ ትእዛዝ ጋዜጣ፣ መጠየቕታታት ክፍሊትን ጽዕነታትን ካብ ሓደ ቦታ ስራሕ የመሓድሩ።",
    "Platform capabilities": "ዓቕሚታት መድረኽ",
    "Built around clear workflows": "ኣብ ግልጺ መስርሓት ዝተሰርሐ",
    "The product connects editorial publishing, reader access, business approval, and delivery status without separate manual workflows.": "እቲ መድረኽ ኤዲቶርያላዊ ሕትመት፣ መእተዊ ኣንባቢ፣ ምጽዳቕ ትካልን ኩነታት መብጽሕን ብዘይ ፍሉያት ብኢድ ዝግበሩ መስርሓት የራኽብ።",
    "Bilingual publishing": "ክልተ ቋንቋ ሕትመት",
    "Editors can publish English and Tigrinya versions of the same article.": "ኤዲተራት ናይ ሓደ ጽሑፍ እንግሊዝን ትግርኛን ቅጥዕታት ከሕትሙ ይኽእሉ።",
    "Managed access": "ዝተመሓደረ መእተዊ",
    "Reader subscriptions and approved company licences control the relevant workspace.": "ምዝገባታት ኣንባቢን ዝጸደቑ ፍቓዳት ትካልን ነቲ ተገቢ ቦታ ስራሕ ይቆጻጸሩ።",
    "Delivery ready": "ንመብጽሒ ድሉው",
    "Saved delivery locations support reader and company shipment operations.": "ዝተዓቀቡ ቦታታት መብጽሒ ስራሕቲ ጽዕነት ኣንባቢን ትካልን ይድግፉ።",
    "Editorial control": "ኤዲቶርያላዊ ቁጽጽር",
    "Subscriber-only articles can be released publicly on an editor-selected date.": "ንተመዝገብቲ ጥራይ ዝተወሰኑ ጽሑፋት ኣብ ብኤዲተር ዝተመርጸ ዕለት ብህዝቢ ክበጽሑ ይኽእሉ።",
    "Two languages": "ክልተ ቋንቋታት",
    "Article content can be maintained in English and Tigrinya.": "ትሕዝቶ ጽሑፍ ብእንግሊዝኛን ትግርኛን ክዕቀብ ይኽእል።",
    "Clear access": "ግልጺ መእተዊ",
    "Subscriptions and company approval decide what each account can use.": "ምዝገባን ምጽዳቕ ትካልን ነፍሲ ወከፍ ሕሳብ እንታይ ከም ዝጥቀም ይውስኑ።",
    "Connected delivery": "ዝተኣሳሰረ መብጽሒ",
    "Saved locations and shipment status support fulfilment operations.": "ዝተዓቀቡ ቦታታትን ኩነታት ጽዕነትን ስራሕቲ ምብጻሕ ይድግፉ።",
    "Shared to reading history": "ናብ ታሪኽ ንባብ ተካፊሉ",
    "Link copied": "መራኸቢ ተቐዲሑ",
    "Saved to reading history": "ኣብ ታሪኽ ንባብ ተዓቂቡ",
    "Removed from saved stories": "ካብ ዝተዓቀቡ ዛንታታት ተወጊዱ",
    "Retrieving story from archives...": "ዛንታ ካብ ማህደር ይምጻእ ኣሎ...",
    "Article Not Found": "ጽሑፍ ኣይተረኽበን",
    "The story you are looking for does not exist or has been archived.": "እቲ እትደልይዎ ዛንታ የለን ወይ ናብ ማህደር ተወሲዱ እዩ።",
    "Share this story": "እዚ ዛንታ ኣካፍል",
    "Remove bookmark": "ምልክት ኣውጽእ",
    "Bookmark this story": "ነዚ ዛንታ ምልክት ግበር",
    "From the News Desk": "ካብ ክፍሊ ዜና",
    "More in this Section": "ተወሳኺ ኣብዚ ክፍሊ",
    "More Headlines": "ተወሳኺ ርእሰ-ዜናታት",
    "In a world where the pace of change continues to accelerate, careful reporting remains more important than ever.": "ኣብ ለውጢ ብቕልጡፍ ዝውስኽ ዓለም፣ ጥንቁቕ ሪፖርታዥ ካብ ቀደም ዝያዳ ኣገዳሲ እዩ።",
    "Full article is reserved for active subscribers.": "ሙሉእ ጽሑፍ ንንጡፋት ተመዝገብቲ ጥራይ ተዓቂቡ እዩ።",
    "Full article stays locked until {date}.": "ሙሉእ ጽሑፍ ክሳብ {date} ተዓጽዩ ይቕጽል።",
    "Subscribe now": "ሕጂ ተመዝገብ",
    "Front Page — Lead Story": "ቀዳማይ ገጽ — ቀንዲ ዛንታ",
    "Photograph:": "ስእሊ፦",
    "Photo:": "ስእሊ፦",
    "/ Newspaper Desk": "/ ክፍሊ ዜና",
    "Front Page Report": "ሪፖርት ቀዳማይ ገጽ",
    Desk: "ክፍሊ",
    "Analysis | Today": "ትንተና | ሎሚ",
    "The Magazine": "መጽሔት",
    "The Big Read": "ዓቢ ንባብ",
    "/ The Magazine": "/ መጽሔት",
    Express: "ቅልጡፍ",
    "Fast Despatch": "ቅልጡፍ ምልኣኽ",
    "Breaking · Top of the Hour": "ሰበር · ቀንዲ ዜና ሰዓት",
    "/ Express Desk": "/ ቅልጡፍ ክፍሊ ዜና",
    Immediate: "ቅልጡፍ",
    "Independent Dispatch": "ናጻ መልእኽቲ",
    "THE DISPATCH": "መልእኽቲ",
    "Issue No. 07": "ሕታም ቁ. 07",
    "The Read": "ንባብ",
    "Delivered to": "ተበጺሑ ናብ",
    readers: "ኣንበብቲ",
    "/ Dispatch": "/ መልእኽቲ",
    "Select layout style": "ዓይነት ቅርጺ ምረጽ",
    "More from this Edition": "ተወሳኺ ካብዚ ሕታም",
    "More From Today's Paper": "ተወሳኺ ካብ ጋዜጣ ሎሚ",
    "More From the Magazine": "ተወሳኺ ካብ መጽሔት",
    "More From the Express": "ተወሳኺ ካብ ቅልጡፍ ዜና",
    "More From the Dispatch": "ተወሳኺ ካብ መልእኽቲ",
    "Subscriber access active": "መእተዊ ተመዝጋቢ ንጡፍ እዩ",
    "Subscriber access": "መእተዊ ተመዝጋቢ",
    "Full article access is active for subscribers (locked to public by Editorial Desk).": "መእተዊ ሙሉእ ጽሑፍ ንተመዝገብቲ ንጡፍ እዩ (ብኤዲቶርያል ክፍሊ ንህዝቢ ተዓጽዩ ኣሎ)።",
    "Full article access is active for all readers (unlocked by Editorial Desk).": "መእተዊ ሙሉእ ጽሑፍ ንኹሎም ኣንበብቲ ንጡፍ እዩ (ብኤዲቶርያል ክፍሊ ተኸፊቱ ኣሎ)።",
    "Full article access is active for signed-in readers.": "መእተዊ ሙሉእ ጽሑፍ ንዝኣተዉ ኣንበብቲ ንጡፍ እዩ።",
    "Subscriber-only story (Locked)": "ዛንታ ንተመዝገብቲ ጥራይ (ተዓጽዩ)",
    "Locked by Editorial Desk": "ብኤዲቶርያል ክፍሊ ተዓጽዩ",
    "This reporting is reserved for active subscribers by the Editorial Desk.": "እዚ ሪፖርታዥ ብኤዲቶርያል ክፍሊ ንንጡፋት ተመዝገብቲ ጥራይ ተዓቂቡ እዩ።",
    "Public archive access": "መእተዊ ህዝባዊ ማህደር",
    "Public archive": "ህዝባዊ ማህደር",
    "This story has been opened to all readers by the Editorial Desk.": "እዚ ዛንታ ብኤዲቶርያል ክፍሊ ንኹሎም ኣንበብቲ ተኸፊቱ ኣሎ።",
    "This story is now open to all readers because the access window has passed.": "ዕድል መእተዊ ስለ ዝሓለፈ፣ እዚ ዛንታ ሕጂ ንኹሎም ኣንበብቲ ክፉት እዩ።",
    "Recent subscriber-only story": "ሓድሽ ዛንታ ንተመዝገብቲ ጥራይ",
    "Subscriber-only access": "መእተዊ ንተመዝገብቲ ጥራይ",
    "This reporting stays reserved for active subscribers during the recent-access window.": "እዚ ሪፖርታዥ ኣብ እዋን ሓድሽ መእተዊ ንንጡፋት ተመዝገብቲ ጥራይ ተዓቂቡ ይቕጽል።",
  },
};
...
function translateContent(language, text) {
  if (typeof text !== "string" || language !== "ti") return text;

  const direct = contentTranslations.ti[text];
  if (direct) return direct;

  const reservedUntil = text.match(/^This reporting stays reserved for active subscribers until (.+)\.$/);
  if (reservedUntil) {
    return `እዚ ሪፖርታዥ ክሳብ ${reservedUntil[1]} ንንጡፋት ተመዝገብቲ ጥራይ ተዓቂቡ ይቕጽል።`;
  }

  const opensPublicly = text.match(/^Opens publicly (.+)$/);
  if (opensPublicly) {
    return `ብህዝቢ ዝኽፈት ${opensPublicly[1]}`;
  }

  const lockedUntil = text.match(/^Full article stays locked until (.+)\.$/);
  if (lockedUntil) {
    return `ሙሉእ ጽሑፍ ክሳብ ${lockedUntil[1]} ተዓጽዩ ይቕጽል።`;
  }

  const archiveOpens = text.match(/^Full article access is active\. Public archive opens on (.+)\.$/);
  if (archiveOpens) {
    return `መእተዊ ሙሉእ ጽሑፍ ንጡፍ እዩ። ህዝባዊ ማህደር ብ${archiveOpens[1]} ይኽፈት።`;
  }
...
export function LanguageProvider({ children }) {
  ...
  const value = React.useMemo(
    () => ({
      ...
      t: (text) => translateContent(language, text),
